...
class Mails:
    ...
    def get_mails_list(self):
        ...
        {"from":"vHack XT","id":"579218","subject":"Mission Reward!","time":"1502967015","read":"0"},
        {"from":"vHack XT","id":"293963","subject":"Special reward!","time":"1502564235","read":"1"},
        {"from":"vHack XT","id":"289849","subject":"Tournament Reward","time":"1502528410","read":"1"}]}
        '''
        response = self.ut.requestString(self.username, self.password, self.uhash, "vh_mails.php", action="list")
    ...
    def get_mail(self, mID):
        ...
        Return mail details
        '''
        return self.ut.requestString(self.username, self.password, self.uhash, "vh_mails.php", action="getmail", mID=mID)
